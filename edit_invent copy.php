    ...
    ?>
      ...
      <table class="table table-striped table-bordered table-condensed" id="rec_items" style="margin-bottom: 4px">
        ...
        <tr>
            ...
            <td>
              <input class="col-xs-1 form-control" type="number" id="num_cases" step="any" name="qty[]" value="<?php echo $cases; ?>" >
            </td>
            ...
            <td>
              <input type="checkbox" name="tad[<?php echo $cnt; ?>]" id="tad[<?php echo $cnt; ?>]" <?php if ($tad==1) {
                        echo "checked";
                    } ?>>
            </td>

            <td>
              <input class="col-xs-1 form-control" type="number" id="discount" step=".01" name="discount[]" value="<?php if ($discount=="") {
                        echo 0;
                    } else {
                        echo $discount;
                    } ?>">
            ...
            <td><input class="col-xs-1 form-control" type="number" id="taxrate" step=".01" name="taxrate[]"  value="<?php if ($taxrate=="") {
                        echo 0;
                    } else {
                        echo $taxrate;
                    } ?>"onblur="compute_rows()"></td>
