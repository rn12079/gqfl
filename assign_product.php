...
const getsuppliers = () => {
    ...
    postData('getdata.php',data).then(res => {
      ...
      res.forEach(sup => {
        ...
        <td><a href='assignprod.php?id=${sup.id}' class='btn btn-info btn-xs'>Assign Products</a></td></tr>`;
...
<body>
 <?php include('navbar.html');
  ...
  <div class="jumbotron">
    <div class="container">
      <strong>Assign Product to Supplier</strong>
   </div>
 </div>
 ...
 <div class="container">
    ...
    <input type='text' id='supplier' placeholder='supplier' onkeyup='getsuppliers()'/>
