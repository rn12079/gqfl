...
$subquery = "select distinct id from products where product_name='".$product."' and product_type='".$product_type. "'";
$subquery = $subquery . " and product_sub_type='".$product_sub_type."' and supplier='".$supplier."'";

$myquery="insert into inventory(date,receiver,product_id,cases,amount,invoice_ref,acc_ref,invoice_img_ref) values('";
$myquery = $myquery . $t_date . "','" . $receiver . "',(" . $subquery . ")," . $qty . "," . $amount;
...
echo "Successful :  1 record added"
;
mysqli_close ($conn);
//}
?>
