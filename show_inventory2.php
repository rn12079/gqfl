...
<body onload="init()">
  <div class="tp">
    ...
    <div class="lp" id="mlp">
      ...
      <form  action="show_inventory2.php" method="post" enctype="multipart/form-data">
        <table border="1px">
          <tr><td>
          ...
          <tr>
            <td>
              ...
              <td>
              <input list="xx" placeholder="Product" id="product_name" name="product_name"  autocomplete="off" 
